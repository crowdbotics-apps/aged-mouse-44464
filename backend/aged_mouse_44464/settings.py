"""
Django settings for aged_mouse_44464 project.
...
ROOT_URLCONF = 'aged_mouse_44464.urls'
...
WSGI_APPLICATION = 'aged_mouse_44464.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_mouse_44464 API",
    "DESCRIPTION": "API documentation for aged_mouse_44464 App",
    "VERSION": "v1",
}
